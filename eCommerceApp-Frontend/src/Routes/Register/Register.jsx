                ...
                >
                    <Box 
                        ...
                        <Box display={"flex"} alignItems={"center"} padding={2} >
                            <DeveloperBoardIcon sx={{color: 'white', opacity: 0.7, fontSize: 100}} />
                            <Typography sx={{opacity: 0.8}} textAlign={'center'} fontFamily={'Bungee Regular'} fontSize={25} color={'white'}>
                                Your journey in the world of tech is just about to begin</Typography>
                        </Box>
                    </Box>
                </Grid>
